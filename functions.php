...
function theindigomill_styles() {
	...
	wp_enqueue_script( 'intersection-observer-polyfill', get_stylesheet_directory_uri() . '/js/intersection-observer.js', array(), 1.0, true );
	wp_enqueue_script( 'theindigomill-scripts', get_stylesheet_directory_uri() . '/js/main.js', array('intersection-observer-polyfill'), 1.0, true );
}
